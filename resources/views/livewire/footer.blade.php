    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="logo">
                    <a href="/">
                        <img src="/assets/img/logo.png" style="height: 65px;">
                    </a>
                    <ul class="d-flex social-media">
                        <li><a href="https://www.facebook.com/wakandasolarsystems.co.zw?mibextid=ZbWKwL"><i class="fa-brands fa-facebook"></i>facebook</a></li>
                        <li><a href="https://x.com/wakandasolar_?s=09"><i class="fa-brands fa-twitter"></i>Twitter</a></li>
                        <li><a href="https://www.instagram.com/wakanda_solar_systems?igsh=YTc2eWhwYmRnOXVm"><i class="fa-brands fa-instagram"></i>instagram</a></li>
                        <li><a href="https://www.tiktok.com/@wakandasolarsystems?_t=8o4lRL5EwRK&_r=1"><i class="fa-brands fa-tiktok"></i>tiktok</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="about-energix">
                    <h5>About Wakanda Solar Systems</h5>
                    <p>Solar energy’s exceptional synergies with energy storage, electric vehicles and smart grids means the
                        industry works on the frontline of technology and system change to deliver.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="about-energix">
        ...
        <div class="row contact-footer">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="contact-info">
                    ...
                    <div>
                        <p>287 Samora Machel Road,Harare Zimababwe</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="contact-info mb-0">
                    ...
                    <div>
                        <h4>Email Address:</h4>
                        <a>
                            <p><span>shingirayinhera@gmail.com</span></p>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom">
            <p>Ⓒ Copyright Wakanda Solar Systems 2024. All Right Reserved.</p>
            <ul>
