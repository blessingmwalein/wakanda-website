    ...
    <div class="top-bar">
        <div class="container">
            <div class="top-bar-text">
                <ul class="d-flex">
                    <li><a href="https://www.facebook.com/wakandasolarsystems.co.zw?mibextid=ZbWKwL" target="_blank"><i class="fa-brands fa-facebook"></i>facebook</a></li>
                ...
                <div class="d-flex top-bar-mail">
                    <div class="d-flex align-items-center me-4">
                        ...
                        <a href="">
                            <p><span class="">shingirayinhera@gmail.com </span></p>
                        </a>
                    </div>
        ...
        <div class="about-energix">
            ...
            <div class="d-flex align-items-center top-bar-mail">
                <div class="d-flex align-items-center">
                    ...
                    <a href="">
                        <p><span >shingirai@wakandasolar.co.zw, shingirayinhera@gmail.com</span></p>
                    </a>
                </div>
            </div>
        </div>
